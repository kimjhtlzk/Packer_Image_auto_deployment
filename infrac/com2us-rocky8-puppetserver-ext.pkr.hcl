...
# 설치 내용
  provisioner "shell" {
    ...
    inline = [
      ...
      "sudo dnf -y install https://yum.theforeman.org/releases/3.11/el8/x86_64/foreman-release.rpm",
      "sudo dnf -y module enable foreman:el8", # foreman 3.10 기준 postgresql 12 버전까지만 지원하는 것으로 확인됨
